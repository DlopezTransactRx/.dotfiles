...
move_left="$(get_tmux_option "@vim_navigator_mapping_left" 'M-h')"
move_right="$(get_tmux_option "@vim_navigator_mapping_right" 'M-l')"
move_up="$(get_tmux_option "@vim_navigator_mapping_up" 'M-k')"
move_down="$(get_tmux_option "@vim_navigator_mapping_down" 'M-j')"
move_prev="$(get_tmux_option "@vim_navigator_mapping_prev" 'M-\')"
